...
| `send-estimate-email` | Send estimate via Resend (`Kurtis@SprayBossPro.com`); reads template from `email_templates`; falls back to `Leads` table if no client email found |
...
- From address: `Kurtis@SprayBossPro.com`
