...
| `send-estimate-email` | Send estimate via Resend (`mail@spraybosspro.com`); reads template from `email_templates`; falls back to `Leads` table if no client email found |
...
- From address: `mail@spraybosspro.com`
